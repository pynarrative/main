...
class myStyle(Style):
    def __init__(self):
        ...
        self.set_colors(
            ...
            nextstep_box = main_color.replace("rgb", "rgba").replace(")", ", 0.5)"),
...
class inflationTemplate(Template):
    """
